#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────────────────────
// build-html.mjs — stitches engine.js + vcf-design-studio-v5.jsx into the
// shipped single-file vcf-design-studio-v5.html artifact.
//
...
const JSX_SRC    = path.join(ROOT, "vcf-design-studio-v5.jsx");
const HTML_OUT   = path.join(ROOT, "vcf-design-studio-v5.html");
...
<head>
  ...
  <title>VCF Design Studio — v5</title>
...
<body>
  <!--
    ...
    vcf-design-studio-v5.jsx. Do not hand-edit — run \`npm run build-html\`.
  -->
  <div id="root"></div>
  <script>
${engine}
